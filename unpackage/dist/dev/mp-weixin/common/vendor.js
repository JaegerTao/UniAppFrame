...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"Frame","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var _storage = _interopRequireDefault(__webpack_require__(/*! ../common/storage.js */ 38));
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    //设置头像和微信名
    setWxInfo: function setWxInfo(state, _ref) {
  ...
  actions: {
    ...
    asessionid: function asessionid(_ref2, sessionid) {
...
var _typeof2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/typeof */ 13));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _Vregular = _interopRequireDefault(__webpack_require__(/*! ./Vregular.js */ 42));
var _Vrules;
//正则验证
var Vrules = (_Vrules = {
  phone: {
...
}, (0, _defineProperty2.default)(_Vrules, "positiveInteger", {
  pattern: _Vregular.default.positiveInteger
}), (0, _defineProperty2.default)(_Vrules, "char0to20", {
  pattern: _Vregular.default.char0to20
}), (0, _defineProperty2.default)(_Vrules, "char0to30", {
  pattern: _Vregular.default.char0to30
}), (0, _defineProperty2.default)(_Vrules, "char0to50", {
  pattern: _Vregular.default.char0to50,
  errMess: '输入不超过50字'
}), (0, _defineProperty2.default)(_Vrules, "noEmpty", {
  pattern: _Vregular.default.noEmpty
}), _Vrules);
var verification = {};
          ...
          var _ret = function () {
            ...
            if (regular[i] == "req") {
              if (otherPra.reqEmptyVal) {
                // 必填项未填写内容提示
                var emptyMessage = "请输入" + option.formData[m].label;
